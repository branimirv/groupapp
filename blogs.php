...
<section class="blog-hero">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <?php if (have_posts()) :  query_posts('tag=featured&showposts=1'); ?>
            ...
            <article class="blog-hero__card">
              <div class="blog-hero__content">
                <div class="blog-hero__meta">
                  <div class="blog-hero__categories">
                    ...
                    if ($categories && ! is_wp_error($categories)) :
                      foreach ($categories as $index => $category) :
                        ...
                        $has_category_page = url_to_postid($category_link) !== 0;
                    ?>
                        <span class="blog-hero__meta-item blog-hero__meta-item--category blog-hero__meta-item--category-<?php echo (int) $index + 1; ?>">
                          ...
                          <?php if ($has_category_page) : ?>
                            <a class="blog-hero__meta-label" href="<?php echo esc_url($category_link); ?>"><?php echo esc_html($category->name); ?></a>
                          <?php else : ?>
                            <span class="blog-hero__meta-label"><?php echo esc_html($category->name); ?></span>
                          <?php endif; ?>
                        </span>
                    <?php
                      endforeach;
                  ...
                  <div class="blog-hero__reading-time">
                    <span class="blog-hero__meta-item blog-hero__meta-item--reading-time">
                      <svg class="blog-hero__meta-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <g clip-path="url(#clip0_blog_hero_reading_time)">
                        ...
                        <defs>
                          <clipPath id="clip0_blog_hero_reading_time">
                            <rect width="16" height="16" fill="white" />
                          </clipPath>
                        </defs>
                      </svg>
                      <span class="blog-hero__meta-label"><?php echo do_shortcode('[rt_reading_time]'); ?> min read</span>
                    </span>
                  </div>
                </div>
                ...
                <div class="blog-hero__media blog-hero__media--mobile">
                  <a href="<?php the_permalink(); ?>" class="blog-hero__media-link">
                    <?php the_post_thumbnail('post-thumb', ['class' => 'blog-hero__image']); ?>
                  </a>
                </div>

                <div class="blog-hero__excerpt">
                  <?php the_excerpt(); ?>
                </div>

                <a href="<?php the_permalink(); ?>" class="blog-hero__cta btn btn--withArrow">
                  <span class="txt">Read story</span>
              ...
              <div class="blog-hero__media blog-hero__media--desktop">
                <a href="<?php the_permalink(); ?>" class="blog-hero__media-link">
                  <?php the_post_thumbnail('post-thumb', ['class' => 'blog-hero__image']); ?>
                </a>
              </div>
...
<section class="blog-list">
  <div class="container">
    ...
    <?php if ($blog_list_query->max_num_pages > 1) : ?>
      <nav class="blog-list__pagination" aria-label="<?php esc_attr_e('Blog pagination', 'groupapp'); ?>">
        <?php wp_pagenavi(array('query' => $blog_list_query)); ?>
      </nav>

      <?php if ($paged === $blog_list_query->max_num_pages - 2 && $blog_list_query->max_num_pages > 5) : ?>
        <script>
          document.querySelector('.blog-list__pagination .wp-pagenavi')?.classList.add('del-last-span');
        </script>
      <?php endif; ?>

      <?php if ($paged === 3 && $blog_list_query->max_num_pages > 5) : ?>
        <script>
